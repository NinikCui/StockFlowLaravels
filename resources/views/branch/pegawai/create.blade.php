<x-app-layout :branchCode="$branchCode">
    ...
    <div class="max-w-4xl mx-auto px-6 py-10 space-y-10">
        ...
        {{-- HEADER --}}
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Tambah Pegawai Cabang</h1>
            <p class="text-gray-600 mt-1">Tambahkan akun pegawai untuk cabang ini</p>
        </div>
        ...
        <div class="bg-white border border-gray-200 shadow-sm rounded-2xl p-8">
            ...
            <form method="POST" action="{{ route('branch.pegawai.store', $branchCode) }}" class="space-y-6">
                @csrf
