    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                {{-- KEMBALI --}}
                <a href="{{ route('branch.po.index', $branchCode) }}"
                ...
                <div class="flex items-center gap-3">
                    ...
                    @if ($po->status == 'DRAFT')
                        ...
                        {{-- EDIT --}}
                        <a href="{{ route('branch.po.edit', [$branchCode, $po->id]) }}"
                        class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium">
                            Edit PO
                        </a>

                        {{-- DELETE --}}
                        <form action="{{ route('branch.po.destroy', [$branchCode, $po->id]) }}"
                            method="POST"
                        ...
                        {{-- APPROVE --}}
                        <form action="{{ route('branch.po.updateStatus', [$branchCode, $po->id]) }}"
                            method="POST">
                            @csrf @method('PATCH')
                    ...
                    @if ($po->status == 'APPROVED')
                        ...
                        {{-- RECEIVE --}}
                        <a href="{{ route('branch.po.receive.show', [$branchCode, $po->id]) }}"
