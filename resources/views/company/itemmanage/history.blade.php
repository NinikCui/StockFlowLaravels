...
<div class="max-w-7xl mx-auto px-6 py-10 space-y-8">
    ...
    <div>
        ...
        <p class="text-gray-600 mt-1 text-sm">
            Semua riwayat perubahan stok dari seluruh cabang.
        </p>
    </div>
    ...
    =============================== --}}
    <form method="GET"
          class="bg-white p-4 rounded-xl shadow-sm border grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div class="col-span-full flex justify-end pt-2 gap-2">
            <button class="bg-emerald-600 text-white px-6 py-2 rounded-lg shadow hover:bg-emerald-700">
                Terapkan Filter
            </button>

            <a href="{{ route('itemmanage.history', [
                'companyCode' => request()->route('companyCode'),
                'item' => $item->id
            ]) }}"
            class="bg-gray-100 px-6 py-2 rounded-lg shadow text-gray-700 hover:bg-gray-200">
                Reset
            </a>
        </div>
