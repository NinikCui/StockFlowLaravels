            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($suppliers as $s)
                    <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                        ...
                        <td class="py-4 px-6">
                            @if($s->cabangResto)
                                <span class="inline-flex items-center px-3 py-1 rounded-lg bg-emerald-50 border border-emerald-200 
                                    ...
                                    {{ $s->cabangResto->name }} Scope
                                </span>
                            @else
                                <span class="inline-flex items-center px-3 py-1 rounded-lg bg-blue-50 border border-blue-200 
                        ...
                        {{-- KPI METRICS --}}
                        <td class="py-4 px-6">
                            @include('company.supplier.partials.kpi-mini', ['s' => $s])
                        </td>
