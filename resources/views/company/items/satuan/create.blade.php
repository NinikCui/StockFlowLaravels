...
<main class="max-w-3xl mx-auto px-6 py-10">
    ...
    {{-- TITLE --}}
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Tambah Satuan</h1>
        <p class="text-gray-500 text-sm mt-1">
            Tambahkan satuan baru untuk item.
        </p>
    </div>
    ...
    <div class="bg-white border rounded-xl p-6 shadow-sm">
        ...
        <form method="POST" action="{{ route('items.satuan.store', $companyCode) }}" class="space-y-6">
            @csrf
