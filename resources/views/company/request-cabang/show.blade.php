            ...
            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    @if($req->status === 'REQUESTED')
                        <a href="{{ route('request.edit', [$companyCode, $req->id]) }}"
                           class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 active:bg-blue-800 transition-all duration-150 shadow-sm hover:shadow">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
