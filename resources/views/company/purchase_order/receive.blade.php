    ...
    >
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            type="number"
                            class="receive-input mt-1 w-full border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500 focus:border-emerald-500"
                    ...
                    <div>
                        ...
                        <input
                            type="number"
                            class="return-input mt-1 w-full border-gray-300 rounded-lg shadow-sm focus:ring-rose-500 focus:border-rose-500"
                            data-max="{{ $detail->qty_ordered }}"
        ...
        <div class="flex justify-between pt-4">
            ...
            <a href="{{ route('po.show', [$companyCode, $po->id]) }}"
